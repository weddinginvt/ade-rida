...
function rsvp() {
    ...
    if (nameRv == '') {
        ...
        window.open("https://api.whatsapp.com/send?phone=6285318830818&text=Halo%20Ade%20%26%20Rida%2C%20saya%20%2A" + nameRv + "%2A%20dari%20%2A" + alamatRv + "%2A%20ingin%20konfirmasi%20kehadiran%20undangan%20pernikahan%20kalian%20bahwa%20%2A" + checked.value + "%2A%0A%20%0ATerimakasih.", "_blank");
    }
}
